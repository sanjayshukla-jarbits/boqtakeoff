...
using boqtakeoff.res;
using boqtakeoff.core;

namespace boqtakeoff.ui
{
    /// <summary>
    ...
    public static class RevitPushButton
    {
        ...
        public static PushButton Create(RevitPushButtonDataModel data)
        {
            ...
            // Use provided assembly path, or fall back to executing assembly
            string assemblyPath = !string.IsNullOrEmpty(data.AssemblyPath) 
                ? data.AssemblyPath 
